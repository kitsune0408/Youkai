namespace YoukaiKingdom.Logic
{
    ...
    public class GameEngine
    {
        ...
        public void Start()
        {
            this.HeroClass.Inventory.EquipMainHand(new OneHandedSword(1, "TestSword", 1, 100));
            this.HeroClass.Inventory.EquipOffHand(new Shield(2, "TestShield", 1, 150));
            this.HeroClass.Inventory.EquipArmor(new BodyArmor(3, "BodyArmorTest", 1, 200));
            ...
            var newItem = new OneHandedSword(6, "TestSword2", 1, 200);
